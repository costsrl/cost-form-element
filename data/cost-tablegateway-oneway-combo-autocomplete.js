...
var  CostComboAutocompleteTableGateway = {
		init: function(selector) {
			$(selector)
			.find("select[data-Costtablegatwayacinit='Cost-tablegatway-oneway-combo-autocomplete']")
			.each(function() {
				...
				$(this).select2({
					ajax: {
						url: '/Cost-tablegateway-oneway-select-autocomplete/'+ _class + '/' + _property + '/' + _tag,  
						dataType: 'json',
						delay: 250,
...
$(document).ready(function() {
	...
	CostComboAutocompleteTableGateway.init('body');
});